...
Os resultados obtidos permitiram observar o comportamento da distribuição F para diferentes graus de liberdade.

Por meio dos gráficos desenvolvidos na linguagem R, foi possível visualizar que a distribuição F assume apenas valores positivos e apresenta assimetria à direita.

Além disso, observou-se que o formato da distribuição F varia conforme os graus de liberdade utilizados na análise, tornando-se menos assimétrica à medida que esses valores aumentam.

A aplicação utilizando sensores no contexto da Engenharia Mecatrônica demonstrou a importância da distribuição F na comparação de variâncias e análise da precisão dos sistemas de medição.
