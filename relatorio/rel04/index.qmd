...
# --- Simulação de Cenários (Distribuição Completa) ---
...
É revelante para compreensão de casos onde se tem um sensor de posição com uma resolução de 0,01 mm, o qual o erro de leitura está distribuído uniformemente entre $-0,005$ e $+0,005$;
...
cat("Média Esperada:", (a + b) / 2, "mm | Média Simulada:", round(media_simulada, 4), "mm\n")
cat("Desvio Padrão Teórico:", round(sd_teorico, 4), "mm\n")
cat("Desvio Padrão Simulado:", round(sd_simulado, 4), "mm\n")
cat("----------------------------------------\n")
...
Fórmula: $t$.$$f(t) = \lambda e^{-\lambda t} \quad \text{para } t \ge 0$$
